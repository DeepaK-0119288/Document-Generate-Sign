...
router.post('/:id/documents',checkLoginStatus,requestUpload.array('documents', 100),documentController.uploadDocuments);
...
router.post('/:id/dispatch', checkLoginStatus, signatureController.dispatchRequest);
